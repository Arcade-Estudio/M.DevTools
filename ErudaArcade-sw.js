// ============================================================
// ErudaArcade - Eruda + Custom Plugins Service Worker
// ============================================================
// Inyecta Eruda automaticamente en cada pagina del proyecto
// AppTab unificado: App | NetWat | Elements | Inspect
// ============================================================

const CACHE_NAME = 'ErudaArcade-v1'
const ERUDA_CDN = 'https://cdn.jsdelivr.net/npm/eruda'

// === PLUGIN UNIFICADO EMBEBIDO ===
const APP_TAB_CODE = `
(function(){
...
const ALL_PLUGINS = APP_TAB_CODE
